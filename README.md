...
* **Enemy variety** – melee enemies chase the player; ranged enemies move slower but shoot projectiles on a cooldown.  **Turret enemies** sit in place but unleash bullets in all eight directions.  **Bosses** appear in the final room, firing radial spreads of bullets and periodically summoning additional minions.
* **Potions** – randomly spawn and heal the player by 25 health points upon collection.
* **Upgrades** – after clearing a room (except the final boss room) a random upgrade item appears.  Upgrades can increase bullet damage, decrease your firing cooldown, boost movement speed or increase maximum health.  Additional upgrades introduced in later iterations include **Spread Shot** (fire multiple bullets at once) and **Shield** (absorb incoming hits).
